...
function createParamsFile()
{
	...
	local NormsUtilityWindowSize=${14}
	...
	echo "  <parameter name='SimNumCarsToEmit'         	value='$SimNumCarsToEmit'		type='constant' constant_type='number' />" >>  $fileName
	...
	echo "  <parameter name='NormsUtilityWindowSize'        value='$NormsUtilityWindowSize'		type='constant' constant_type='number' />" >> $fileName
